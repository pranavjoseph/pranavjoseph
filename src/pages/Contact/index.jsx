...
function ContactPage() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(".contact-title", { y: -30, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 })
        .fromTo(".contact-desc", { y: -20, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 }, "-=0.6")
        .fromTo(".left-col", { x: -50, opacity: 0 }, { x: 0, opacity: 1, duration: 0.8 }, "-=0.4")
        .fromTo(".right-col", { x: 50, opacity: 0 }, { x: 0, opacity: 1, duration: 0.8 }, "-=0.6")
        .fromTo(".contact-link", { y: 20, opacity: 0 }, { y: 0, opacity: 1, stagger: 0.1, duration: 0.5 }, "-=0.4");
      ...
      <div ref={containerRef} className="relative z-10 transition-colors duration-300 h-screen overflow-y-auto overflow-x-hidden flex flex-col">
        ...
        <div className="px-6 pt-20 pb-4 text-center max-w-4xl mx-auto flex-shrink-0">
          <div className="text-center md:text-left">
            <h1 className="contact-title text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
              Let's Connect
            </h1>
            <p className="contact-desc text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
          ...
          <div className="right-col min-w-0">
            {!submitted ? (
              <form ref={formRef} onSubmit={handleSubmit} className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md border border-white/20 dark:border-gray-700 p-6 rounded-3xl shadow-2xl space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    value={formData.name}
                    className={`w-full px-4 py-2 rounded-xl border ${errors.name ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200 dark:border-gray-600'} bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-sm`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 rounded-xl border ${errors.email ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200 dark:border-gray-600'} bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-sm`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-2 rounded-xl border ${errors.message ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200 dark:border-gray-600'} bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none text-sm`}
                ...
                <button
                  type="submit"
                  disabled={isSending}
                  className={`w-full py-3 px-6 rounded-xl font-bold text-base shadow-lg transform transition-all duration-200 ${isSending ? "bg-gray-400 cursor-not-allowed" : "bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 hover:shadow-xl hover:-translate-y-1"}`}
                >
              ...
              <div ref={successRef} className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-8 rounded-3xl shadow-xl text-center">
                ...
                <button onClick={() => setSubmitted(false)} className="mt-4 text-blue-600 dark:text-blue-400 font-semibold hover:underline text-sm">Send another message</button>
              </div>
            )}
          </div>
        </div>
